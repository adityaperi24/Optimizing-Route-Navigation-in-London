...
def visualize_multiple_path(start: str, end: str, n: int) -> None:
    ...
    if dict_path != {}:
        ...
        print('HOORAY! A map with the possible multiple paths has been traced and generated. '
        ...
        print(f'Sorry! No such shortest path exists between the {start} and {end} junctions.')
        return None
...
def visualize_path_specific_stops(start: str, end: str, num_stops: int) -> Tuple[bool, float]:
    ...
    if dict_path != {}:
        ...
        if specific_stops_paths != []:
            ...
            print('HOORAY! A map with paths with specific stops has been traced and generated. '
...
def visualize_shortest_path(start: str, end: str) -> bool:
    ...
    if dict_path != {} and shortest_path != []:
        ...
        print('HOORAY! A map with the shortest route has been traced and generated. '
...
def visualize_direct_path(start: str, end: str) -> bool:
    ...
    if dict_path != {} and direct_path != []:
        ...
        print('HOORAY! A map with most direct paths has been traced and generated. '
...
def visualize_shortest_time_path(start: str, end: str, mode: str) -> bool:
    ...
    if dict_path != {}:
        ...
        print('HOORAY! A map with the shortest time paths has been traced and generated. '
              'Please open the "shortest_route.html" file under Plots_Generated folder '
              'to view the plot.')
