...
functions to read road map data, add junctions, add roads, get distance, location, vehcile data, compute the time between two junctions, and create the graph according to the dataset.
...
class RoadSystem:
    ...
    def add_junction(self, road_name: Any) -> None:
        ...
        if road_name in self.junctions:
            return None
        else:
    ...
    def add_road(self, junction1_name: str, junction2_name: str,
        ...
        Preconditions:
          ...
          - motor >= 0
        """
        if junction1_name in self.junctions and junction2_name in self.junctions:
